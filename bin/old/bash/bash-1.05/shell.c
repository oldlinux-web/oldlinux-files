...
#ifdef DEBUG
printf("before shell_name++ argv[0] = %s; ", argv[0]);
#endif
...
#ifdef DEBUG
printf("after shell_name++ argv[0] = %s; ", argv[0]);
#endif
...
#ifdef DEBUG
printf("before savestring argv[0] = %s; ", argv[0]);
#endif

  dollar_vars[0] = savestring (argv[0]);

#ifdef DEBUG
printf("after savestring argv[0] = %s;\n", argv[0]);
#endif
