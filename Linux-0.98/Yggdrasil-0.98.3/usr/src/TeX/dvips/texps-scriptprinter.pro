...
ObliqueFont /Times-BoldOblique /Times-Bold 15 ObliqueFont
/Times-ItalicUnslanted /Times-Italic -15.15 ObliqueFont /pf{4736286.72 div
Resolution mul /ptsize exch def /PSname exch def /TeXname exch def dmystr 2
TeXname cvx(@@@)cvs putinterval PSname newname ReEncodeForTeX newname newname
ptsize TeXPSmakefont def TeXname{/foo setfont}2 array copy cvx def TeXname
