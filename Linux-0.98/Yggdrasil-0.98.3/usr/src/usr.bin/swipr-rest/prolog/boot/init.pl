/*  @(#) init.pl 1.4.0 (UvA SWI) Mon Jan 1 18:02:00 MET 1990
...
:- user:dynamic(library_directory/1).
:- user:multifile(library_directory/1).
...
$open_source_call(Goal, yes) :-
	Goal, !.
$open_source_call(_, no).
