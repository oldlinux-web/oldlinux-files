#ifndef MAC
char *versio = "C-Kermit 5A(184) BETA-6, 12 Oct 92"; /* Version herald. */
#else
/*
  For Macintosh, also remember to change the Mac-specific version in ckmkr2.r.
*/
char *versio = "Mac Kermit 0.99(184) Pre-ALPHA, 11 Oct 92";
#endif /* MAC */
long vernum = 501184L;
/*
...
/*
  ...
  Digital Press, Burlington, MA, USA.  Publication date: Fall 1992.
