...
/*
  ...
  Returns 0 if a string was copied, -1 if there was no string to copy.
*/
int
...
/* Check for trailing comment, " ;" or " #" */
		...
		(*(s-1) == ';' || *(s-1) == '#') &&
		(*(s-2) == SP  || *(s-2) == HT)) {
		debug(F110,"Trailing comment",s2,0);
