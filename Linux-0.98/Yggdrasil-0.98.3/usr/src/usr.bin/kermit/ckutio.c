char *ckxv = "UNIX Communications support, 5A(099), 8 Oct 92";
...
/*
  ...
  versions.  We use the POSIX calls rather than ioctl calls because GNU CC
  uses different formats for the _IOxxx macros than regular CC; the POSIX
  forms work for both.
*/
