#ifdef OS2
char *ckzv = "OS/2 file support, 5A(064) 18 Sep 92";
#else
char *ckzv = "UNIX file support, 5A(064) 18 Sep 92";
#endif /* OS2 */
...
/*
  ...
  OS/2 kernel accepts / as directory separator too. But this is subject to
...
#ifdef OS2
    if (n == ZOFILE) strcat(p,"b");	/* OS/2 binary mode */
#endif /* OS2 */
