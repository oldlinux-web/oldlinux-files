#ifndef NODIAL
char *dialv = "Dial Command, 5A(043) 11 Oct 92";
...
#ifdef MINIDIAL
		      continue;		/* Pure CCITT, keep looking */
#else
		      {
			  if (augmdmtyp == n_DIGITEL) /* Assume connected */
			    mdmstat = CONNECTED;
			  else		/* Pure CCITT, keep looking */
			    continue;
		      }
#endif /* MINIDIAL */
		    break;
...
getok(n, strict) int n, strict; {
	...
	waitfor("VAL");			/* Except this won't work if modem */
        return(1);			/* doesn't understand HUP & says INV */
