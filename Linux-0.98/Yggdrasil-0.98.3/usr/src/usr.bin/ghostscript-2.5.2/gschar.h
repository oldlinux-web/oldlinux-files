...
int	gs_show_init(P3(gs_show_enum *, gs_state *, const char *)),
	...
	gs_widthshow_init(P6(gs_show_enum *, gs_state *, floatp, floatp, char, const char *)),
	gs_widthshow_n_init(P7(gs_show_enum *, gs_state *, floatp, floatp, char, const char *, uint)),
	gs_awidthshow_init(P8(gs_show_enum *, gs_state *, floatp, floatp, char, floatp, floatp, const char *)),
	gs_awidthshow_n_init(P9(gs_show_enum *, gs_state *, floatp, floatp, char, floatp, floatp, const char *, uint)),
...
int	gs_setmetrics(P4(gs_show_enum *, gs_state *, const gs_point *, const gs_point *));
