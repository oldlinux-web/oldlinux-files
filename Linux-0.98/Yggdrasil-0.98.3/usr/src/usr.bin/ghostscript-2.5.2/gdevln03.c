...
/* Forward references */
private int sixel_printpage(P3(gx_device_printer *pdev, FILE *prn_stream, const char *init));
...
{
return (sixel_printpage(pdev,prn_stream,LN03_INIT));
}
...
{
	return (sixel_printpage(pdev,prn_stream,LA75_INIT));
}
...
{
	return (sixel_printpage(pdev,prn_stream,LA50_INIT));
}
...
private int
sixel_printpage(gx_device_printer *pdev, FILE *prn_stream, const char *init)
{
    byte *in, *inp;
